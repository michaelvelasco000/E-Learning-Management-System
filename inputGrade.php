                            ...
                            <table class="table table-striped table-bordered dt-responsive nowrap" id="datatable">
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_array($query)) {
                                        ...
                                        $student_query1 = mysqli_query($connection, "select * from student where student_id='" . $row['student_id'] . "'") or die($connection->error);
                                        $student_row1 = mysqli_fetch_array($student_query1);
                                    ...
                                    ?>
                                        ...
                                        <tr class="odd gradeX" id="username">
                                            ...
                                            <td><?php echo $student_row1['firstname'] ." ".$student_row1['lastname']; ?></td>
                                            <td><?php echo $row['first']; ?></td>
                                            <td><?php echo $row['second']; ?></td>
                                           
                                          
                                            <td>
                                            <a  href="editGrades.php <?php echo '?id=' . $id; ?>"  class="btn btn-success"><i class="bx bxs-edit"></i>Edit&nbsp;</a>
                                                <button type="button" class="btn btn-danger btn-md" data-toggle="modal" data-target="#delete<?php echo $id ?>"><i class="bi bi-archive-fill"></i></button>
