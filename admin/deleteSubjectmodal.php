   ...
   <div id="delete<?php echo $subject_id ?>" class="modal fade" tabindex="-1" role="dialog"  aria-labelledby="myModalLabel">
    ...
    <div class="col-md-12 position-relative">
         ...
         <div class="modal-footer">
          <button type="submit" class="btn btn-danger" data-dismiss="modal">Close</button>
            <button type="submit" class="btn btn-primary waves-effect waves-light" name="btn_del"><i class="mdi mdi-check-bold"></i> Yes</button>
         </div>
     </div>
            <!-- /.modal-content -->
   </div>
