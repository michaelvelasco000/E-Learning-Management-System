...
<body>
    <?php 
        ...
        if (isset($_GET['email']) && isset($_GET['reset_token'])) {
            ...
            $sql="SELECT * FROM superadmin WHERE email = '$email' AND resettoken = '$reset_token' AND resettokenexp = '$date'";
        ...
        if (isset($_POST['update'])) {
            ...
            $update = "UPDATE superadmin SET password='$pass',resettoken='NULL',resettokenexp=NULL WHERE email = '$email'";
