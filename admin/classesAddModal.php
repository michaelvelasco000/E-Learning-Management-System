...
<form  enctype="multipart/form-data" method="POST" action="classesAdd.php">
  <div class="modal-dialog modal-md">
    ...
    <div class="col-md-12 position-relative">
          <div class="form-group">
              <label for="validationTooltip01" style="float: left" class="mb-2">Teacher <span style="color:red;">*</span></label>
               <select name="teacher_id" id="validationTooltip01" class="form-control" required>
                  <option id="shes"></option>
                  <?php
                  $teacher = mysqli_query($conn,"select * from teacher") or die (mysqli_error($conn));
