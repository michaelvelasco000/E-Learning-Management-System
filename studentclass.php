    ...
    <section class="container section__height">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <?php
                if ($count != '0') {
                    $query = mysqli_query($connection, "SELECT * from student_class where student_id='$session_id' AND delete_status = 0") or die($connection->error);
                ...
                <div class="col-md-4">
                    ...
                    <div class="card mb-3 " style="background-color: rgba(255, 255, 255, 1);">
                        <b>
                            <p class="text-black"> <?php echo $rowCourse['cys']; ?></p>
                        </b>
                        <div class="cover-photo">
                            <img src="uploads/<?php echo $teacher_row['location']; ?>" class="profile">
                        </div>
                        <br>
                        <p class="about" id="titles"><b
                                class="text-capitalize text-black"><br><?php echo $rowSubject['subject_title']; ?> <br>
                                <?php echo $teacher_row['firstname'] . ' ' . $teacher_row['middlename'] . ' ' . $teacher_row['lastname']; ?></b>
                        </p><br>
                        <a href="studentGrades.php?id=<?php echo $i ?>" class="btn txt"><i class="fa fa-eye"></i>
                            Grades</a>
                        <a href="student_quiz_list.php?id=<?php echo $id ?>" class="btn txt"><i class="fa fa-eye"></i>
                            Quiz</a>
                        <a href="student_class_module.php?id=<?php echo $class_id ?>" class="btn txt"><i
                                class="fa fa-eye"></i> Learning Materials</a>
                ...
                <div class="alert alert-info"><i class="icon-info-sign"></i> You are currently not enroll to your class
                </div>
                <?php } ?>
