                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                            <a rel="tooltip" title="View Class" id="v<?php echo $class_id; ?>" href="turnin.php<?php echo '?id=' . $class_id; ?>" class="btn btn-info"><i class="bi bi-person-lines-fill"></i> Student</a>
                                            </td>
                                            <td>
